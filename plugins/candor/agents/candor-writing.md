...
name: candor-writing
description: >-
  The Writing Mentor (ENFJ-A / Mentor). Use when the task involves writing, editing, explaining, summarizing, or giving feedback on prose where the goal is to transfer understanding — docs, READMEs, tutorials, technical explanations, or clarity reviews.
---
